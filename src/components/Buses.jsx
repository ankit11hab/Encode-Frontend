...
export default function Buses() {
  ...
  const Before6AM = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.pick_up_time <= 6);
  ...
  const After6Am_Before12PM = () => {
    original = BUS_JS;
    var arr = original.filter(
      (item) => item.pick_up_time > 6 && item.pick_up_time <= 12
    );
    setBuses(arr);
  ...
  const After12pm_Before6PM = () => {
    original = BUS_JS;
    var arr = original.filter(
      (item) => item.pick_up_time > 12 && item.pick_up_time <= 18
    );
  ...
  const After6PM_Before12Am = () => {
    original = BUS_JS;
    var arr = original.filter(
      (item) => item.pick_up_time > 18 && item.pick_up_time <= 24
    );
    setBuses(arr);
  ...
  const Before6AMAT = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.drop_time <= 6);
    setBuses(arr);
    setBefore6am(!Before6am);
  };
  const After6Am_Before12PMAT = () => {
    original = BUS_JS;
    var arr = original.filter(
      (item) => item.drop_time > 6 && item.drop_time <= 12
    );
  ...
  const After12pm_Before6PMAT = () => {
    original = BUS_JS;
    var arr = original.filter(
      (item) => item.drop_time > 12 && item.drop_time <= 18
    );
  ...
  const After6PM_Before12AmAT = () => {
    original = BUS_JS;
    var arr = original.filter(
      (item) => item.drop_time > 18 && item.drop_time <= 24
    );
  ...
  const Seater = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.seater === true);

    setBuses(arr);
  };
  const Sleeper = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.sleeper === true);

    setBuses(arr);
  };
  const AC = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.ac === true);

    setBuses(arr);
  };
  const NonAc = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.nonac === true);
  ...
  const WIFI = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.wifi === true);
  ...
  const WATER = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.waterbottle === true);
  ...
  const BLANKET = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.Blankets === true);

    setBuses(arr);
  };
  const CHARGER = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.charging_point === true);
  ...
  const MOVIE = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.Movie === true);
  ...
  const TOILET = () => {
    original = BUS_JS;
    var arr = original.filter((item) => item.toilet === true);
            ...
            <div className='poora1'>
              <div>
                ...
                <div className='bdy'>
                  <img
                    className='imgs'
                    src='https://www.freeiconspng.com/uploads/school-bus-icon-12.png'
                    alt=''
                  />{' '}
                  Live Tracking{' '}
                </div>
                ...
                <div className='bdy'>
                  <img
                    className='imgs'
                    src='https://img.favpng.com/24/16/9/computer-icons-price-tag-png-favpng-7AEYXd10DhTqmZfN87Tb9CsR9.jpg'
                    alt=''
                  />{' '}
                  Red Deals
                </div>
                ...
                <div className='bdy'>
                  ...
                  <img
                    className='imgs'
                    src='https://as2.ftcdn.net/v2/jpg/02/18/43/79/500_F_218437966_oUGkb1oXx2UbAh98zT79TVHDVmhX0Pwf.jpg'
                    alt=''
                  />{' '}
                  Reshedulable
                </div>
              ...
              <div className='inp'>
                ...
                <div className='bdy' onClick={Before6AM}>
                  {Before6am ? (
                    <div style={{ color: 'red' }}>
                      <input type='checkbox' className='inp1' />{' '}
                      <img
                        className='imgs'
                        src='https://freepngimg.com/download/alarm/22921-5-morning-alarm-image.png'
                        alt=''
                      />{' '}
                      <div> Before 6am</div>
                    </div>
                ...
                <div className='bdy' onClick={After6Am_Before12PM}>
                  {Before12pm ? (
                    <div style={{ color: 'red' }}>
                      ...
                      <img
                        className='imgs'
                        src='https://th.bing.com/th/id/R.7753f50f02196a8547d206dc00a485fd?rik=kDj3UsII659w8Q&riu=http%3a%2f%2fcdn.onlinewebfonts.com%2fsvg%2fdownload_183081.png&ehk=PgJb3%2f9xAwPor0E4QcelZk76VKx%2bAJYgz%2bzePpOi5og%3d&risl=&pid=ImgRaw&r=0'
                        alt=''
                      />{' '}
                      <div>6am to 12pm</div>
                    </div>
                ...
                <div className='bdy' onClick={After12pm_Before6PM}>
                  {Before6pm ? (
                    <div style={{ color: 'red' }}>
                      ...
                      <img
                        className='imgs'
                        src='https://cdn.onlinewebfonts.com/svg/img_168368.png'
                        alt=''
                      />{' '}
                      <div>12pm to 6pm</div>
                    </div>
                ...
                <div className='bdy' onClick={After6PM_Before12Am}>
                  {Before12am ? (
                    <div style={{ color: 'red' }}>
                      ...
                      <img
                        className='imgs'
                        src='https://cdn.onlinewebfonts.com/svg/img_447445.png'
                        alt=''
                      />{' '}
                      <div>After 6pm</div>
                    </div>
              ...
              <div className='inp'>
                ...
                <div className='bdy' onClick={WIFI}>
                  {Wifi ? (
                    <div style={{ color: 'red' }}>
                      ...
                      <img
                        className='imgs'
                        src='https://static.vecteezy.com/system/resources/previews/000/441/701/original/wifi-vector-icon.jpg'
                        alt=''
                      />{' '}
                      WIFI
                    </div>
                ...
                <div className='bdy' onClick={WATER}>
                  {Bottle ? (
                    <div style={{ color: 'red' }}>
                      <img
                        className='imgs'
                        src='https://maxcdn.icons8.com/Share/icon/Food/bottle_of_water1600.png'
                        alt=''
                      />{' '}
                      Water Bottle
                    </div>
                ...
                <div className='bdy' onClick={BLANKET}>
                  <div>
                    <img
                      className='imgs'
                      src='https://cdn.iconscout.com/icon/premium/png-256-thumb/blanket-7-582299.png'
                      alt=''
                    />{' '}
                    Blankets
                  </div>
                ...
                <div className='bdy' onClick={CHARGER}>
                  {Charger ? (
                    <div style={{ color: 'red' }}>
                      <img
                        className='imgs'
                        src='https://th.bing.com/th/id/OIP.gfFdPhqu7WhbcXlx2LaCzQHaHa?pid=ImgDet&rs=1'
                        alt=''
                      />{' '}
                      Charging Point
                    </div>
                ...
                <div className='bdy' onClick={MOVIE}>
                  {Movie ? (
                    <div style={{ color: 'red' }}>
                      <img
                        className='imgs'
                        src='https://th.bing.com/th/id/OIP.FX2D4IYJXj70rMJhiIy7hQHaHa?pid=ImgDet&rs=1'
                        alt=''
                      />{' '}
                      Movie
                    </div>
                ...
                <div className='bdy'>
                  <div>
                    <img
                      className='imgs'
                      src='https://cdn4.iconfinder.com/data/icons/track/154/bus-512.png'
                      alt=''
                    />{' '}
                    Track My Bus
                  </div>
                ...
                <div className='bdy' onClick={TOILET}>
                  {Toilet ? (
                    <div style={{ color: 'red' }}>
                      ...
                      <img
                        className='imgs'
                        src='https://img.favpng.com/18/5/15/public-toilet-icon-png-favpng-JBDLZqNXHRjuC2gDzkVZhAMU0.jpg'
                        alt=''
                      />{' '}
                      Toilet
                    </div>
